...
Generated `2026-08-23T20:03:37.306604+00:00`.
...
```json
{
  ...
  "genuine_rigid_directed_diamonds": 288,
  "genuine_touchable_directed_diamonds": 0,
  "nonbaseline_shell_rows": 7904,
  "one_conflict_genuine_replacement_candidates": 0,
  ...
  "reported_steiner_generator_audit": {
    "baseline_diamond_indices_absent_from_balanced_generator": [
      264,
      265,
      266,
      267,
    ...
    "baseline_diamond_indices_reproduced_by_generator": [
      0,
      1,
      2,
      3,
    ...
    "interpretation": "The 528 raw cset=1 rows are two copies each of 264 existing ZE99 diamonds. Their sole conflict is self-inner-product 16. There are zero new cset=1 partners, so the claimed 2^264 independent switch family does not follow from this generator.",
    "raw_cset1_multiplicity_distribution": {
      "2": 264
    },
    "raw_cset1_rows": 528,
    "raw_rows": 3696,
    "unique_cset1_rows": 264,
    "unique_cset1_rows_already_in_baseline": 264,
    "unique_cset1_rows_not_in_baseline": 0,
    "unique_rows": 1848
  },
  "shell_size": 8192
}
